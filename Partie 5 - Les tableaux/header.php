...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-info">
        <a class="navbar-brand font-weight-bold" href="../index.php">PHP PARTIE 5 - LES TABLEAUX</a>
        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../Exercice 9">Exercice 9</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../Exercice 10">Exercice 10</a>
                </li>
            </ul>
        </div>
    </nav>
